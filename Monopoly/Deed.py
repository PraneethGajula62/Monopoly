...
import Master_List.AllDeeds as AllDeeds


class Deed(PlayerAndProperty.Property):
    def __init__(self, color = str, monopoly = bool, houses = int, hotel = bool, mortgage = int, house_cost = int, hotel_cost = int, mortgage_value = int, all_deeds = AllDeeds.all_deeds):
        self.color = color
    ...
    def mortgage_square(self, player = PlayerAndProperty.Player):
        if self.mortgage:
    ...
    def unmortgage_square(self, player = PlayerAndProperty.Player):
